    ...
    internal class EnumerablesValueHandler : IValueHandler
    {
        public object ConvertValue(TypeEquality typeEquality, object value)
        {
            ...
            if (typeEquality.AreEnumerablesTypesEquel)
            {
                ...
                {
                    method =
                        typeof(Generic.Models.GenericModel).GetMethods()
            ...
            else
            {
                    ...
                    targetResolve.IsEnumerableTypeNumeric && sourceResolve.IsEnumerableTypeEnum)
                {
                    ...
                    method = typeof(Generic.Models.GenericModel).GetMethod("ConvertEnumerable", BindingFlags.NonPublic | BindingFlags.Static);
